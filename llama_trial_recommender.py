...
def handle_query(query):
    # Simple keyword-based query classification (can be replaced with ML models)
    recommendation_keywords = ["can I", "suitable for", "if I have", "alternatives", "recommend", "safe for"]
